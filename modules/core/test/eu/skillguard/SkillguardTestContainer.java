...
public class SkillguardTestContainer extends TestContainer {

    public SkillguardTestContainer() {
        super();
    ...
    public static class Common extends SkillguardTestContainer {

        public static final SkillguardTestContainer.Common INSTANCE = new SkillguardTestContainer.Common();
